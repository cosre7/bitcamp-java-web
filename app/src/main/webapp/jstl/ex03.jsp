...
<jsp:useBean id="m1" class="com.eomcs.web.vo.Member"/> <%-- 객체 만들기 --%>
<%-- type : 찾기만 하기
     class : 찾아보고 없으면 객체 만들기 (new Member()) --%>
<%--
...
if (m1 == null) {
 ...
 --%>
<jsp:setProperty name="m1" property="no" value="100"/> <%-- m1 이라는 id를 가진 객체의 no 값에 100을 넣어라 --%>
<%-- 
m1.setNo(100);
--%>

<c:set target="${pageScope.m1}" property="email" value="hong@test.com"/> 
<%-- pageScope 에 있는 m1 객체를 꺼내서 setEmail을 찾아서 hont@test.com 넣기 --%>
<%--
