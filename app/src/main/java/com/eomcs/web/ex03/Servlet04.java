...
public class Servlet04 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // C:\Users\pc\eclipse-workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp1\wtpwebapps\bitcamp-java-web
    ...
    // 그냥 다운로드 대화상자를 띄운다.
    res.setContentType("image/jpeg"); // 헤더값
    //res.setContentType("image/ohora"); // 브라우저가 알 수 없는 파일 -> 다운로드가 실행된다 
    //다운로드 해줄테니까 니가 알아서해...
